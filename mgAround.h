...
enum {
  ...
  MGA_FILL_OUTLINE,
  MGA_REPEATER_ENABLE,
  MGA_REPEATER_COUNT_L,
  MGA_REPEATER_COUNT_R,
  MGA_REPEATER_COUNT_U,
  MGA_REPEATER_COUNT_D,
  MGA_REPEATER_GAP_X,
  MGA_REPEATER_GAP_Y,
  MGA_REPEATER_OFFSET_X,
  MGA_REPEATER_OFFSET_Y,
  MGA_REPEATER_SHOW_TEXT,
  MGA_REPEATER_SHOW_SHAPE,
  MGA_REPEATER_TRANS_X,
  MGA_REPEATER_TRANS_Y,
  MGA_REPEATER_TRANS_ROTATE,
  MGA_NUM_PARAMS
};
...
enum {
  ...
  REPEATER_ENABLE_DISK_ID,
  REPEATER_COUNT_L_DISK_ID,
  REPEATER_COUNT_R_DISK_ID,
  REPEATER_COUNT_U_DISK_ID,
  REPEATER_COUNT_D_DISK_ID,
  REPEATER_GAP_X_DISK_ID,
  REPEATER_GAP_Y_DISK_ID,
  REPEATER_OFFSET_X_DISK_ID,
  REPEATER_OFFSET_Y_DISK_ID,
  REPEATER_SHOW_TEXT_DISK_ID,
  REPEATER_SHOW_SHAPE_DISK_ID,
  REPEATER_TRANS_X_DISK_ID,
  REPEATER_TRANS_Y_DISK_ID,
  REPEATER_TRANS_ROTATE_DISK_ID
};
